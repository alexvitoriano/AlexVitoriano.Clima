...
namespace AlexVitoriano.Clima.Helpers
{
    ...
    public static class Helpers
    {
        ...
        /// </summary>
        private static readonly DateTimeOffset BaseUnixTime = new DateTimeOffset(1970, 1, 1, 0, 0, 0, new TimeSpan(0,0,0));
        ...
        /// <summary>
        /// Verifica se um objeto existe em uma lista
        /// </summary>
        ...
        public static bool IsNightTime => DateTime.Now.Hour < 6 || DateTime.Now.Hour >= 18;

        public static bool IsMadrugada => DateTime.Now.Hour < 6 || DateTime.Now.Hour >= 23;

        public static bool IsTarde => DateTime.Now.Hour > 11 || DateTime.Now.Hour <= 18;
